...
namespace Proto.Promises
{
    public partial struct Promise
    {
        ...
        /// <summary>Executes a for each operation on an <see cref="Linq.AsyncEnumerable{T}"/> in which iterations may run in parallel on <see cref="Promise.Config.BackgroundContext"/>.</summary>
        /// <typeparam name="TSource">The type of the data in the source.</typeparam>
        /// <param name="source">An enumerable data source.</param>
        /// <param name="body">An asynchronous delegate that is invoked once per element in the data source.</param>
        /// <param name="cancelationToken">A cancelation token that may be used to cancel the for each operation.</param>
        ...
        /// <exception cref="System.ArgumentNullException">The exception that is thrown when the <paramref name="source"/> argument or <paramref name="body"/> argument is null.</exception>
        /// <returns>A promise that represents the entire for each operation.</returns>
        public static Promise ParallelForEachAsync<TSource>(Linq.AsyncEnumerable<TSource> source, Func<TSource, CancelationToken, Promise> body,
            CancelationToken cancelationToken = default(CancelationToken), int maxDegreeOfParallelism = -1)
        {
            return Promise<TSource>.ParallelForEachAsync(source, body, Promise.Config.BackgroundContext, cancelationToken, maxDegreeOfParallelism);
        }

        /// <summary>Executes a for each operation on an <see cref="Linq.AsyncEnumerable{T}"/> in which iterations may run in parallel.</summary>
        /// <typeparam name="TSource">The type of the data in the source.</typeparam>
        /// <param name="source">An enumerable data source.</param>
        /// <param name="body">An asynchronous delegate that is invoked once per element in the data source.</param>
        /// <param name="synchronizationContext">The synchronization context on which the iterations will be ran. If null, <see cref="ThreadPool.QueueUserWorkItem(WaitCallback, object)"/> will be used.</param>
        ...
        /// <exception cref="System.ArgumentNullException">The exception that is thrown when the <paramref name="source"/> argument or <paramref name="body"/> argument is null.</exception>
        /// <returns>A promise that represents the entire for each operation.</returns>
        public static Promise ParallelForEachAsync<TSource>(Linq.AsyncEnumerable<TSource> source, Func<TSource, CancelationToken, Promise> body, SynchronizationContext synchronizationContext,
            CancelationToken cancelationToken = default(CancelationToken), int maxDegreeOfParallelism = -1)
        {
        ...
        /// <exception cref="System.ArgumentNullException">The exception that is thrown when the <paramref name="source"/> argument or <paramref name="body"/> argument is null.</exception>
        /// <returns>A promise that represents the entire for each operation.</returns>
        public static Promise ParallelForEachAsync<TSource, TCapture>(Linq.AsyncEnumerable<TSource> source, TCapture captureValue, Func<TSource, TCapture, CancelationToken, Promise> body,
            CancelationToken cancelationToken = default(CancelationToken), int maxDegreeOfParallelism = -1)
        {
            return Promise<TSource>.ParallelForEachAsync(source, captureValue, body, Promise.Config.BackgroundContext, cancelationToken, maxDegreeOfParallelism);
        }
        ...
        /// <exception cref="System.ArgumentNullException">The exception that is thrown when the <paramref name="source"/> argument or <paramref name="body"/> argument is null.</exception>
        /// <returns>A promise that represents the entire for each operation.</returns>
        public static Promise ParallelForEachAsync<TSource, TCapture>(Linq.AsyncEnumerable<TSource> source, TCapture captureValue, Func<TSource, TCapture, CancelationToken, Promise> body, SynchronizationContext synchronizationContext,
            CancelationToken cancelationToken = default(CancelationToken), int maxDegreeOfParallelism = -1)
        {
    ...
    public partial struct Promise<T>
    {
        ...
        /// <exception cref="System.ArgumentNullException">The exception that is thrown when the <paramref name="source"/> argument or <paramref name="body"/> argument is null.</exception>
        /// <returns>A promise that represents the entire for each operation.</returns>
        public static Promise ParallelForEachAsync(Linq.AsyncEnumerable<T> source, Func<T, CancelationToken, Promise> body,
            CancelationToken cancelationToken = default(CancelationToken), int maxDegreeOfParallelism = -1)
        {
        ...
        /// <exception cref="System.ArgumentNullException">The exception that is thrown when the <paramref name="source"/> argument or <paramref name="body"/> argument is null.</exception>
        /// <returns>A promise that represents the entire for each operation.</returns>
        public static Promise ParallelForEachAsync(Linq.AsyncEnumerable<T> source, Func<T, CancelationToken, Promise> body, SynchronizationContext synchronizationContext,
            CancelationToken cancelationToken = default(CancelationToken), int maxDegreeOfParallelism = -1)
        {
            ValidateArgument(source, "source", 1);
            ValidateArgument(body, "body", 1);
        ...
        /// <exception cref="System.ArgumentNullException">The exception that is thrown when the <paramref name="source"/> argument or <paramref name="body"/> argument is null.</exception>
        /// <returns>A promise that represents the entire for each operation.</returns>
        public static Promise ParallelForEachAsync<TCapture>(Linq.AsyncEnumerable<T> source, TCapture captureValue, Func<T, TCapture, CancelationToken, Promise> body,
            CancelationToken cancelationToken = default(CancelationToken), int maxDegreeOfParallelism = -1)
        {
            ValidateArgument(source, "source", 1);
            ValidateArgument(body, "body", 1);
        ...
        /// <exception cref="System.ArgumentNullException">The exception that is thrown when the <paramref name="source"/> argument or <paramref name="body"/> argument is null.</exception>
        /// <returns>A promise that represents the entire for each operation.</returns>
        public static Promise ParallelForEachAsync<TCapture>(Linq.AsyncEnumerable<T> source, TCapture captureValue, Func<T, TCapture, CancelationToken, Promise> body, SynchronizationContext synchronizationContext,
            CancelationToken cancelationToken = default(CancelationToken), int maxDegreeOfParallelism = -1)
        {
            ValidateArgument(source, "source", 1);
            ValidateArgument(body, "body", 1);
