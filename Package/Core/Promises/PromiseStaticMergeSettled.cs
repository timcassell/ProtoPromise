...
namespace Proto.Promises
{
    public partial struct Promise
    {
        ...
        private static void GetAllResultContainer(Internal.PromiseRefBase handler, object rejectContainer, State state, int index, ref IList<ResultContainer> result)
        {
        ...
        public static Promise<IList<ResultContainer>> AllSettled<TEnumerator>(TEnumerator promises, IList<ResultContainer> valueContainer = null) where TEnumerator : IEnumerator<Promise>
        {
            ...
            using (promises)
            {
                ...
                while (promises.MoveNext())
                {
                    ...
                    Internal.PrepareForMerge(p, ref passThroughs, i, ref pendingCount, ref completedProgress, ref maxDepth);
                    // Make sure list has the same count as promises.
                    if (listSize < (i + 1))
                    {
                        ++listSize;
        ...
        private static partial class MergeResultFuncs
        {
            ...
            {
                [MethodImpl(Internal.InlineOption)]
                private static void GetMergeResult(Internal.PromiseRefBase handler, object rejectContainer, State state, int index, ref ValueTuple<ResultContainer, ResultContainer> result)
                {
                    switch (index)
                    {
                        case 0:
        ...
        public static Promise<ValueTuple<ResultContainer, ResultContainer>> MergeSettled<T1>(Promise promise1, Promise promise2)
        {
            ...
            var promise = Internal.PromiseRefBase.GetOrCreateMergeSettledPromise(passThroughs, value, pendingCount, completedProgress, maxDepth, MergeResultFuncs.GetSettled2());
            return new Promise<ValueTuple<ResultContainer, ResultContainer>>(promise, promise.Id, maxDepth);
        }
        ...
        private static partial class MergeResultFuncs
        {
            ...
            {
                [MethodImpl(Internal.InlineOption)]
                private static void GetMergeResult(Internal.PromiseRefBase handler, object rejectContainer, State state, int index, ref ValueTuple<Promise<T1>.ResultContainer, ResultContainer> result)
                {
                    switch (index)
                    {
                        case 0:
        ...
        public static Promise<ValueTuple<Promise<T1>.ResultContainer, ResultContainer>> MergeSettled<T1>(Promise<T1> promise1, Promise promise2)
        {
            ...
            var promise = Internal.PromiseRefBase.GetOrCreateMergeSettledPromise(passThroughs, value, pendingCount, completedProgress, maxDepth, MergeResultFuncs.GetSettled1<T1>());
            return new Promise<ValueTuple<Promise<T1>.ResultContainer, ResultContainer>>(promise, promise.Id, maxDepth);
        }
        ...
        private static partial class MergeResultFuncs
        {
            ...
            {
                [MethodImpl(Internal.InlineOption)]
                private static void GetMergeResult(Internal.PromiseRefBase handler, object rejectContainer, State state, int index, ref ValueTuple<Promise<T1>.ResultContainer, Promise<T2>.ResultContainer> result)
                {
                    switch (index)
                    {
                        case 0:
        ...
        public static Promise<ValueTuple<Promise<T1>.ResultContainer, Promise<T2>.ResultContainer>> MergeSettled<T1, T2>(Promise<T1> promise1, Promise<T2> promise2)
        {
            ...
            var promise = Internal.PromiseRefBase.GetOrCreateMergeSettledPromise(passThroughs, value, pendingCount, completedProgress, maxDepth, MergeResultFuncs.GetSettled0<T1, T2>());
            return new Promise<ValueTuple<Promise<T1>.ResultContainer, Promise<T2>.ResultContainer>>(promise, promise.Id, maxDepth);
        }
        ...
        private static partial class MergeResultFuncs
        {
            ...
            {
                [MethodImpl(Internal.InlineOption)]
                private static void GetMergeResult(Internal.PromiseRefBase handler, object rejectContainer, State state, int index, ref ValueTuple<ResultContainer, ResultContainer, ResultContainer> result)
                {
                    switch (index)
                    {
                        case 0:
            ...
            Promise promise1, Promise promise2, Promise promise3)
        {
            ...
            var promise = Internal.PromiseRefBase.GetOrCreateMergeSettledPromise(passThroughs, value, pendingCount, completedProgress, maxDepth, MergeResultFuncs.GetSettled3());
            return new Promise<ValueTuple<ResultContainer, ResultContainer, ResultContainer>>(promise, promise.Id, maxDepth);
        }
        ...
        private static partial class MergeResultFuncs
        {
            ...
            {
                [MethodImpl(Internal.InlineOption)]
                private static void GetMergeResult(Internal.PromiseRefBase handler, object rejectContainer, State state, int index, ref ValueTuple<Promise<T1>.ResultContainer, ResultContainer, ResultContainer> result)
                {
                    switch (index)
                    {
                        case 0:
            ...
            Promise<T1> promise1, Promise promise2, Promise promise3)
        {
            ...
            var promise = Internal.PromiseRefBase.GetOrCreateMergeSettledPromise(passThroughs, value, pendingCount, completedProgress, maxDepth, MergeResultFuncs.GetSettled2<T1>());
        ...
        private static partial class MergeResultFuncs
        {
            ...
            {
                [MethodImpl(Internal.InlineOption)]
                private static void GetMergeResult(Internal.PromiseRefBase handler, object rejectContainer, State state, int index, ref ValueTuple<Promise<T1>.ResultContainer, Promise<T2>.ResultContainer, ResultContainer> result)
                {
                    switch (index)
                    {
                        case 0:
            ...
            Promise<T1> promise1, Promise<T2> promise2, Promise promise3)
        {
            ...
            var promise = Internal.PromiseRefBase.GetOrCreateMergeSettledPromise(passThroughs, value, pendingCount, completedProgress, maxDepth, MergeResultFuncs.GetSettled1<T1, T2>());
        ...
        private static partial class MergeResultFuncs
        {
            ...
            {
                [MethodImpl(Internal.InlineOption)]
                private static void GetMergeResult(Internal.PromiseRefBase handler, object rejectContainer, State state, int index, ref ValueTuple<Promise<T1>.ResultContainer, Promise<T2>.ResultContainer, Promise<T3>.ResultContainer> result)
                {
                    switch (index)
                    {
                        case 0:
            ...
            Promise<T1> promise1, Promise<T2> promise2, Promise<T3> promise3)
        {
            ...
            var promise = Internal.PromiseRefBase.GetOrCreateMergeSettledPromise(passThroughs, value, pendingCount, completedProgress, maxDepth, MergeResultFuncs.GetSettled0<T1, T2, T3>());
        ...
        private static partial class MergeResultFuncs
        {
            ...
            {
                [MethodImpl(Internal.InlineOption)]
                private static void GetMergeResult(Internal.PromiseRefBase handler, object rejectContainer, State state, int index, ref ValueTuple<ResultContainer, ResultContainer, ResultContainer, ResultContainer> result)
                {
                    switch (index)
                    {
                        case 0:
            ...
            Promise promise1, Promise promise2, Promise promise3, Promise promise4)
        {
            ...
            var promise = Internal.PromiseRefBase.GetOrCreateMergeSettledPromise(passThroughs, value, pendingCount, completedProgress, maxDepth, MergeResultFuncs.GetSettled4());
            return new Promise<ValueTuple<ResultContainer, ResultContainer, ResultContainer, ResultContainer>>(promise, promise.Id, maxDepth);
        }
        ...
        private static partial class MergeResultFuncs
        {
            ...
            {
                [MethodImpl(Internal.InlineOption)]
                private static void GetMergeResult(Internal.PromiseRefBase handler, object rejectContainer, State state, int index, ref ValueTuple<Promise<T1>.ResultContainer, ResultContainer, ResultContainer, ResultContainer> result)
                {
                    switch (index)
                    {
                        case 0:
            ...
            Promise<T1> promise1, Promise promise2, Promise promise3, Promise promise4)
        {
            ...
            var promise = Internal.PromiseRefBase.GetOrCreateMergeSettledPromise(passThroughs, value, pendingCount, completedProgress, maxDepth, MergeResultFuncs.GetSettled3<T1>());
        ...
        private static partial class MergeResultFuncs
        {
            ...
            {
                [MethodImpl(Internal.InlineOption)]
                private static void GetMergeResult(Internal.PromiseRefBase handler, object rejectContainer, State state, int index, ref ValueTuple<Promise<T1>.ResultContainer, Promise<T2>.ResultContainer, ResultContainer, ResultContainer> result)
                {
                    switch (index)
                    {
                        case 0:
            ...
            Promise<T1> promise1, Promise<T2> promise2, Promise promise3, Promise promise4)
        {
            ...
            var promise = Internal.PromiseRefBase.GetOrCreateMergeSettledPromise(passThroughs, value, pendingCount, completedProgress, maxDepth, MergeResultFuncs.GetSettled2<T1, T2>());
        ...
        private static partial class MergeResultFuncs
        {
            ...
            {
                [MethodImpl(Internal.InlineOption)]
                private static void GetMergeResult(Internal.PromiseRefBase handler, object rejectContainer, State state, int index, ref ValueTuple<Promise<T1>.ResultContainer, Promise<T2>.ResultContainer, Promise<T3>.ResultContainer, ResultContainer> result)
                {
                    switch (index)
                    {
                        case 0:
            ...
            Promise<T1> promise1, Promise<T2> promise2, Promise<T3> promise3, Promise promise4)
        {
            ...
            var promise = Internal.PromiseRefBase.GetOrCreateMergeSettledPromise(passThroughs, value, pendingCount, completedProgress, maxDepth, MergeResultFuncs.GetSettled1<T1, T2, T3>());
        ...
        private static partial class MergeResultFuncs
        {
            ...
            {
                [MethodImpl(Internal.InlineOption)]
                private static void GetMergeResult(Internal.PromiseRefBase handler, object rejectContainer, State state, int index, ref ValueTuple<Promise<T1>.ResultContainer, Promise<T2>.ResultContainer, Promise<T3>.ResultContainer, Promise<T4>.ResultContainer> result)
                {
                    switch (index)
                    {
                        case 0:
            ...
            Promise<T1> promise1, Promise<T2> promise2, Promise<T3> promise3, Promise<T4> promise4)
        {
            ...
            var promise = Internal.PromiseRefBase.GetOrCreateMergeSettledPromise(passThroughs, value, pendingCount, completedProgress, maxDepth, MergeResultFuncs.GetSettled0<T1, T2, T3, T4>());
        ...
        private static partial class MergeResultFuncs
        {
            ...
            {
                [MethodImpl(Internal.InlineOption)]
                private static void GetMergeResult(Internal.PromiseRefBase handler, object rejectContainer, State state, int index, ref ValueTuple<ResultContainer, ResultContainer, ResultContainer, ResultContainer, ResultContainer> result)
                {
                    switch (index)
                    {
                        case 0:
            ...
            Promise promise1, Promise promise2, Promise promise3, Promise promise4, Promise promise5)
        {
            ...
            var promise = Internal.PromiseRefBase.GetOrCreateMergeSettledPromise(passThroughs, value, pendingCount, completedProgress, maxDepth, MergeResultFuncs.GetSettled5());
            return new Promise<ValueTuple<ResultContainer, ResultContainer, ResultContainer, ResultContainer, ResultContainer>>(promise, promise.Id, maxDepth);
        }
        ...
        private static partial class MergeResultFuncs
        {
            ...
            {
                [MethodImpl(Internal.InlineOption)]
                private static void GetMergeResult(Internal.PromiseRefBase handler, object rejectContainer, State state, int index, ref ValueTuple<Promise<T1>.ResultContainer, ResultContainer, ResultContainer, ResultContainer, ResultContainer> result)
                {
                    switch (index)
                    {
                        case 0:
            ...
            Promise<T1> promise1, Promise promise2, Promise promise3, Promise promise4, Promise promise5)
        {
            ...
            var promise = Internal.PromiseRefBase.GetOrCreateMergeSettledPromise(passThroughs, value, pendingCount, completedProgress, maxDepth, MergeResultFuncs.GetSettled4<T1>());
        ...
        private static partial class MergeResultFuncs
        {
            ...
            {
                [MethodImpl(Internal.InlineOption)]
                private static void GetMergeResult(Internal.PromiseRefBase handler, object rejectContainer, State state, int index, ref ValueTuple<Promise<T1>.ResultContainer, Promise<T2>.ResultContainer, ResultContainer, ResultContainer, ResultContainer> result)
                {
                    switch (index)
                    {
                        case 0:
            ...
            Promise<T1> promise1, Promise<T2> promise2, Promise promise3, Promise promise4, Promise promise5)
        {
            ...
            var promise = Internal.PromiseRefBase.GetOrCreateMergeSettledPromise(passThroughs, value, pendingCount, completedProgress, maxDepth, MergeResultFuncs.GetSettled3<T1, T2>());
        ...
        private static partial class MergeResultFuncs
        {
            ...
            {
                [MethodImpl(Internal.InlineOption)]
                private static void GetMergeResult(Internal.PromiseRefBase handler, object rejectContainer, State state, int index, ref ValueTuple<Promise<T1>.ResultContainer, Promise<T2>.ResultContainer, Promise<T3>.ResultContainer, ResultContainer, ResultContainer> result)
                {
                    switch (index)
                    {
                        case 0:
            ...
            Promise<T1> promise1, Promise<T2> promise2, Promise<T3> promise3, Promise promise4, Promise promise5)
        {
            ...
            var promise = Internal.PromiseRefBase.GetOrCreateMergeSettledPromise(passThroughs, value, pendingCount, completedProgress, maxDepth, MergeResultFuncs.GetSettled2<T1, T2, T3>());
        ...
        private static partial class MergeResultFuncs
        {
            ...
            {
                [MethodImpl(Internal.InlineOption)]
                private static void GetMergeResult(Internal.PromiseRefBase handler, object rejectContainer, State state, int index, ref ValueTuple<Promise<T1>.ResultContainer, Promise<T2>.ResultContainer, Promise<T3>.ResultContainer, Promise<T4>.ResultContainer, ResultContainer> result)
                {
                    switch (index)
                    {
                        case 0:
            ...
            Promise<T1> promise1, Promise<T2> promise2, Promise<T3> promise3, Promise<T4> promise4, Promise promise5)
        {
            ...
            var promise = Internal.PromiseRefBase.GetOrCreateMergeSettledPromise(passThroughs, value, pendingCount, completedProgress, maxDepth, MergeResultFuncs.GetSettled1<T1, T2, T3, T4>());
        ...
        private static partial class MergeResultFuncs
        {
            ...
            {
                [MethodImpl(Internal.InlineOption)]
                private static void GetMergeResult(Internal.PromiseRefBase handler, object rejectContainer, State state, int index, ref ValueTuple<Promise<T1>.ResultContainer, Promise<T2>.ResultContainer, Promise<T3>.ResultContainer, Promise<T4>.ResultContainer, Promise<T5>.ResultContainer> result)
                {
                    switch (index)
                    {
                        case 0:
            ...
            Promise<T1> promise1, Promise<T2> promise2, Promise<T3> promise3, Promise<T4> promise4, Promise<T5> promise5)
        {
            ...
            ValidateArgument(promise5, "promise5", 1);
            var v4 = default(T5);
            Internal.PrepareForMerge(promise5, ref v4, ref passThroughs, 4, ref pendingCount, ref completedProgress, ref maxDepth);
            ...
            var promise = Internal.PromiseRefBase.GetOrCreateMergeSettledPromise(passThroughs, value, pendingCount, completedProgress, maxDepth, MergeResultFuncs.GetSettled0<T1, T2, T3, T4, T5>());
        ...
        private static partial class MergeResultFuncs
        {
            ...
            {
                [MethodImpl(Internal.InlineOption)]
                private static void GetMergeResult(Internal.PromiseRefBase handler, object rejectContainer, State state, int index, ref ValueTuple<ResultContainer, ResultContainer, ResultContainer, ResultContainer, ResultContainer, ResultContainer> result)
                {
                    switch (index)
                    {
                        case 0:
            ...
            Promise promise1, Promise promise2, Promise promise3, Promise promise4, Promise promise5, Promise promise6)
        {
            ...
            var promise = Internal.PromiseRefBase.GetOrCreateMergeSettledPromise(passThroughs, value, pendingCount, completedProgress, maxDepth, MergeResultFuncs.GetSettled6());
            return new Promise<ValueTuple<ResultContainer, ResultContainer, ResultContainer, ResultContainer, ResultContainer, ResultContainer>>(promise, promise.Id, maxDepth);
        }
        ...
        private static partial class MergeResultFuncs
        {
            ...
            {
                [MethodImpl(Internal.InlineOption)]
                private static void GetMergeResult(Internal.PromiseRefBase handler, object rejectContainer, State state, int index, ref ValueTuple<Promise<T1>.ResultContainer, ResultContainer, ResultContainer, ResultContainer, ResultContainer, ResultContainer> result)
                {
                    switch (index)
                    {
                        case 0:
            ...
            Promise<T1> promise1, Promise promise2, Promise promise3, Promise promise4, Promise promise5, Promise promise6)
        {
            ...
            var promise = Internal.PromiseRefBase.GetOrCreateMergeSettledPromise(passThroughs, value, pendingCount, completedProgress, maxDepth, MergeResultFuncs.GetSettled5<T1>());
        ...
        private static partial class MergeResultFuncs
        {
            ...
            {
                [MethodImpl(Internal.InlineOption)]
                private static void GetMergeResult(Internal.PromiseRefBase handler, object rejectContainer, State state, int index, ref ValueTuple<Promise<T1>.ResultContainer, Promise<T2>.ResultContainer, ResultContainer, ResultContainer, ResultContainer, ResultContainer> result)
                {
                    switch (index)
                    {
                        case 0:
            ...
            Promise<T1> promise1, Promise<T2> promise2, Promise promise3, Promise promise4, Promise promise5, Promise promise6)
        {
            ...
            var promise = Internal.PromiseRefBase.GetOrCreateMergeSettledPromise(passThroughs, value, pendingCount, completedProgress, maxDepth, MergeResultFuncs.GetSettled4<T1, T2>());
        ...
        private static partial class MergeResultFuncs
        {
            ...
            {
                [MethodImpl(Internal.InlineOption)]
                private static void GetMergeResult(Internal.PromiseRefBase handler, object rejectContainer, State state, int index, ref ValueTuple<Promise<T1>.ResultContainer, Promise<T2>.ResultContainer, Promise<T3>.ResultContainer, ResultContainer, ResultContainer, ResultContainer> result)
                {
                    switch (index)
                    {
                        case 0:
            ...
            Promise<T1> promise1, Promise<T2> promise2, Promise<T3> promise3, Promise promise4, Promise promise5, Promise promise6)
        {
            ...
            var promise = Internal.PromiseRefBase.GetOrCreateMergeSettledPromise(passThroughs, value, pendingCount, completedProgress, maxDepth, MergeResultFuncs.GetSettled3<T1, T2, T3>());
        ...
        private static partial class MergeResultFuncs
        {
            ...
            {
                [MethodImpl(Internal.InlineOption)]
                private static void GetMergeResult(Internal.PromiseRefBase handler, object rejectContainer, State state, int index, ref ValueTuple<Promise<T1>.ResultContainer, Promise<T2>.ResultContainer, Promise<T3>.ResultContainer, Promise<T4>.ResultContainer, ResultContainer, ResultContainer> result)
                {
                    switch (index)
                    {
                        case 0:
            ...
            Promise<T1> promise1, Promise<T2> promise2, Promise<T3> promise3, Promise<T4> promise4, Promise promise5, Promise promise6)
        {
            ...
            var promise = Internal.PromiseRefBase.GetOrCreateMergeSettledPromise(passThroughs, value, pendingCount, completedProgress, maxDepth, MergeResultFuncs.GetSettled2<T1, T2, T3, T4>());
        ...
        private static partial class MergeResultFuncs
        {
            ...
            {
                [MethodImpl(Internal.InlineOption)]
                private static void GetMergeResult(Internal.PromiseRefBase handler, object rejectContainer, State state, int index, ref ValueTuple<Promise<T1>.ResultContainer, Promise<T2>.ResultContainer, Promise<T3>.ResultContainer, Promise<T4>.ResultContainer, Promise<T5>.ResultContainer, Promise<T6>.ResultContainer> result)
                {
                    switch (index)
                    {
                        case 0:
            ...
            Promise<T1> promise1, Promise<T2> promise2, Promise<T3> promise3, Promise<T4> promise4, Promise<T5> promise5, Promise<T6> promise6)
        {
            ...
            ValidateArgument(promise6, "promise6", 1);
            var v5 = default(T6);
            Internal.PrepareForMerge(promise6, ref v5, ref passThroughs, 5, ref pendingCount, ref completedProgress, ref maxDepth);
            ...
            var promise = Internal.PromiseRefBase.GetOrCreateMergeSettledPromise(passThroughs, value, pendingCount, completedProgress, maxDepth, MergeResultFuncs.GetSettled0<T1, T2, T3, T4, T5, T6>());
        ...
        private static partial class MergeResultFuncs
        {
            ...
            {
                [MethodImpl(Internal.InlineOption)]
                private static void GetMergeResult(Internal.PromiseRefBase handler, object rejectContainer, State state, int index, ref ValueTuple<ResultContainer, ResultContainer, ResultContainer, ResultContainer, ResultContainer, ResultContainer, ResultContainer> result)
                {
                    switch (index)
                    {
                        case 0:
            ...
            Promise promise1, Promise promise2, Promise promise3, Promise promise4, Promise promise5, Promise promise6, Promise promise7)
        {
            ...
            var promise = Internal.PromiseRefBase.GetOrCreateMergeSettledPromise(passThroughs, value, pendingCount, completedProgress, maxDepth, MergeResultFuncs.GetSettled7());
            return new Promise<ValueTuple<ResultContainer, ResultContainer, ResultContainer, ResultContainer, ResultContainer, ResultContainer, ResultContainer>>(promise, promise.Id, maxDepth);
        }
        ...
        private static partial class MergeResultFuncs
        {
            ...
            {
                [MethodImpl(Internal.InlineOption)]
                private static void GetMergeResult(Internal.PromiseRefBase handler, object rejectContainer, State state, int index, ref ValueTuple<Promise<T1>.ResultContainer, ResultContainer, ResultContainer, ResultContainer, ResultContainer, ResultContainer, ResultContainer> result)
                {
                    switch (index)
                    {
                        case 0:
            ...
            Promise<T1> promise1, Promise promise2, Promise promise3, Promise promise4, Promise promise5, Promise promise6, Promise promise7)
        {
            ...
            var promise = Internal.PromiseRefBase.GetOrCreateMergeSettledPromise(passThroughs, value, pendingCount, completedProgress, maxDepth, MergeResultFuncs.GetSettled6<T1>());
        ...
        private static partial class MergeResultFuncs
        {
            ...
            {
                [MethodImpl(Internal.InlineOption)]
                private static void GetMergeResult(Internal.PromiseRefBase handler, object rejectContainer, State state, int index, ref ValueTuple<Promise<T1>.ResultContainer, Promise<T2>.ResultContainer, ResultContainer, ResultContainer, ResultContainer, ResultContainer, ResultContainer> result)
                {
                    switch (index)
                    {
                        case 0:
            ...
            Promise<T1> promise1, Promise<T2> promise2, Promise promise3, Promise promise4, Promise promise5, Promise promise6, Promise promise7)
        {
            ...
            var promise = Internal.PromiseRefBase.GetOrCreateMergeSettledPromise(passThroughs, value, pendingCount, completedProgress, maxDepth, MergeResultFuncs.GetSettled5<T1, T2>());
        ...
        private static partial class MergeResultFuncs
        {
            ...
            {
                [MethodImpl(Internal.InlineOption)]
                private static void GetMergeResult(Internal.PromiseRefBase handler, object rejectContainer, State state, int index, ref ValueTuple<Promise<T1>.ResultContainer, Promise<T2>.ResultContainer, Promise<T3>.ResultContainer, ResultContainer, ResultContainer, ResultContainer, ResultContainer> result)
                {
                    switch (index)
                    {
                        case 0:
            ...
            Promise<T1> promise1, Promise<T2> promise2, Promise<T3> promise3, Promise promise4, Promise promise5, Promise promise6, Promise promise7)
        {
            ...
            var promise = Internal.PromiseRefBase.GetOrCreateMergeSettledPromise(passThroughs, value, pendingCount, completedProgress, maxDepth, MergeResultFuncs.GetSettled4<T1, T2, T3>());
        ...
        private static partial class MergeResultFuncs
        {
            ...
            {
                [MethodImpl(Internal.InlineOption)]
                private static void GetMergeResult(Internal.PromiseRefBase handler, object rejectContainer, State state, int index, ref ValueTuple<Promise<T1>.ResultContainer, Promise<T2>.ResultContainer, Promise<T3>.ResultContainer, Promise<T4>.ResultContainer, ResultContainer, ResultContainer, ResultContainer> result)
                {
                    switch (index)
                    {
                        case 0:
            ...
            Promise<T1> promise1, Promise<T2> promise2, Promise<T3> promise3, Promise<T4> promise4, Promise promise5, Promise promise6, Promise promise7)
        {
            ...
            var promise = Internal.PromiseRefBase.GetOrCreateMergeSettledPromise(passThroughs, value, pendingCount, completedProgress, maxDepth, MergeResultFuncs.GetSettled3<T1, T2, T3, T4>());
            ...
            Promise<T1> promise1, Promise<T2> promise2, Promise<T3> promise3, Promise<T4> promise4, Promise<T5> promise5, Promise promise6, Promise promise7)
        {
            ...
            var promise = Internal.PromiseRefBase.GetOrCreateMergeSettledPromise(passThroughs, value, pendingCount, completedProgress, maxDepth, MergeResultFuncs.GetSettled2<T1, T2, T3, T4, T5>());
            return new Promise<ValueTuple<Promise<T1>.ResultContainer, Promise<T2>.ResultContainer, Promise<T3>.ResultContainer, Promise<T4>.ResultContainer, Promise<T5>.ResultContainer, ResultContainer, ResultContainer>>(
                promise, promise.Id, maxDepth);
        }
        ...
        private static partial class MergeResultFuncs
        {
            ...
            {
                [MethodImpl(Internal.InlineOption)]
                private static void GetMergeResult(Internal.PromiseRefBase handler, object rejectContainer, State state, int index, ref ValueTuple<Promise<T1>.ResultContainer, Promise<T2>.ResultContainer, Promise<T3>.ResultContainer, Promise<T4>.ResultContainer, Promise<T5>.ResultContainer, Promise<T6>.ResultContainer, ResultContainer> result)
                {
                    switch (index)
                    {
                        case 0:
            ...
            Promise<T1> promise1, Promise<T2> promise2, Promise<T3> promise3, Promise<T4> promise4, Promise<T5> promise5, Promise<T6> promise6, Promise promise7)
        {
            ...
            var promise = Internal.PromiseRefBase.GetOrCreateMergeSettledPromise(passThroughs, value, pendingCount, completedProgress, maxDepth, MergeResultFuncs.GetSettled1<T1, T2, T3, T4, T5, T6>());
            ...
            Promise<T1> promise1, Promise<T2> promise2, Promise<T3> promise3, Promise<T4> promise4, Promise<T5> promise5, Promise<T6> promise6, Promise<T7> promise7)
        {
            ...
            ValidateArgument(promise7, "promise7", 1);
            var v6 = default(T7);
            Internal.PrepareForMerge(promise7, ref v6, ref passThroughs, 6, ref pendingCount, ref completedProgress, ref maxDepth);
            ...
            var promise = Internal.PromiseRefBase.GetOrCreateMergeSettledPromise(passThroughs, value, pendingCount, completedProgress, maxDepth, MergeResultFuncs.GetSettled0<T1, T2, T3, T4, T5, T6, T7>());
