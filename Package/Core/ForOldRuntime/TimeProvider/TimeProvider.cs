...
// Unity hasn't adopted .Net 8 yet, but when they do, we don't want this to conflict with the built-in TimeProvider.
// TODO: Update compilation symbol if necessary when Unity adopts .Net 8+.
#if UNITY_2018_3_OR_NEWER && !NET8_0_OR_GREATER
...
namespace System
{
    ...
    public abstract class TimeProvider
    {
        ...
        public DateTimeOffset GetLocalNow()
        {
            ...
            if (zoneInfo is null)
            {
                throw new InvalidOperationException("InvalidOperation_TimeProviderNullLocalTimeZone");
            }
        ...
        public TimeSpan GetElapsedTime(long startingTimestamp, long endingTimestamp)
        {
            ...
            {
                throw new InvalidOperationException("InvalidOperation_TimeProviderInvalidTimestampFrequency");
            }
        ...
        private sealed class SystemTimeProviderTimer : ITimer
        {
            ...
            public SystemTimeProviderTimer(TimeSpan dueTime, TimeSpan period, TimerCallback callback, object state)
            {
                ...
                timerState.Timer = _timer = new Timer(s =>
                {
