...
namespace Proto.Promises
{
...
#endif
    public readonly struct PromiseFirstWithIndexGroup
    {
        private readonly CancelationSource _cancelationSource;

        internal PromiseFirstWithIndexGroup(CancelationSource cancelationSource)
        {
            _cancelationSource = cancelationSource;
        }

        /// <summary>
        /// Get a new <see cref="PromiseFirstWithIndexGroup"/> and the <see cref="CancelationToken"/> tied to it.
        /// </summary>
        ...
        public static PromiseFirstWithIndexGroup New(out CancelationToken groupCancelationToken)
            => New(CancelationToken.None, out groupCancelationToken);

        /// <summary>
        /// Get a new <see cref="PromiseFirstWithIndexGroup"/> that will be canceled when the <paramref name="sourceCancelationToken"/> is canceled, and the <see cref="CancelationToken"/> tied to it.
        /// </summary>
        ...
        public static PromiseFirstWithIndexGroup New(CancelationToken sourceCancelationToken, out CancelationToken groupCancelationToken)
        {
        ...
        public PromiseFirstWithIndexGroup Add(Promise promise)
        {
    ...
    [DebuggerNonUserCode, StackTraceHidden]
#endif
    public readonly struct PromiseFirstWithIndexGroup<T>
    {
        private readonly CancelationSource _cancelationSource;
        ...
        /// </summary>
        /// <param name="groupCancelationToken">The token that will be canceled if any of the promises in the group are rejected or canceled.</param>
        public static PromiseFirstWithIndexGroup<T> New(out CancelationToken groupCancelationToken)
            => New(CancelationToken.None, out groupCancelationToken);

        /// <summary>
        /// Get a new <see cref="PromiseFirstWithIndexGroup{T}"/> that will be canceled when the <paramref name="sourceCancelationToken"/> is canceled, and the <see cref="CancelationToken"/> tied to it.
        /// </summary>
        /// <param name="sourceCancelationToken">The token used to cancel the group early.</param>
        /// <param name="groupCancelationToken">The token that will be canceled if <paramref name="sourceCancelationToken"/> is canceled or any of the promises in the group are rejected or canceled.</param>
        public static PromiseFirstWithIndexGroup<T> New(CancelationToken sourceCancelationToken, out CancelationToken groupCancelationToken)
        {
        ...
        public PromiseFirstWithIndexGroup<T> Add(Promise<T> promise)
        {
