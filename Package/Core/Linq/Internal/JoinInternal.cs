...
namespace Proto.Promises
{
    partial class Internal
    {
        ...
        internal static class JoinHelper<TKey>
        {
            ...
            [DebuggerNonUserCode, StackTraceHidden]
#endif
            private readonly struct JoinIterator<TOuter, TInner, TOuterKeySelector, TInnerKeySelector, TEqualityComparer> : IAsyncIterator<(TOuter Outer, TInner Inner)>
                ...
                where TEqualityComparer : IEqualityComparer<TKey>
            {
                ...
                internal JoinIterator(AsyncEnumerator<TOuter> outerAsyncEnumerator,
            ...
            internal static AsyncEnumerable<(TOuter Outer, TInner Inner)> Join<TOuter, TInner, TOuterKeySelector, TInnerKeySelector, TEqualityComparer>(
                ...
                where TInnerKeySelector : IFunc<TInner, CancelationToken, Promise<TKey>>
                where TEqualityComparer : IEqualityComparer<TKey>
                => AsyncEnumerable<(TOuter Outer, TInner Inner)>.Create(
                    new JoinIterator<TOuter, TInner, TOuterKeySelector, TInnerKeySelector, TEqualityComparer>(outerAsyncEnumerator, innerAsyncEnumerator, outerKeySelector, innerKeySelector, comparer));

#if !PROTO_PROMISE_DEVELOPER_MODE
            [DebuggerNonUserCode, StackTraceHidden]
#endif
            private readonly struct ConfiguredJoinIterator<TOuter, TInner, TOuterKeySelector, TInnerKeySelector, TEqualityComparer> : IAsyncIterator<(TOuter Outer, TInner Inner)>
                where TOuterKeySelector : IFunc<TOuter, CancelationToken, Promise<TKey>>
                where TInnerKeySelector : IFunc<TInner, CancelationToken, Promise<TKey>>
                where TEqualityComparer : IEqualityComparer<TKey>
            {
                ...
                internal ConfiguredJoinIterator(ConfiguredAsyncEnumerable<TOuter>.Enumerator configuredOuterAsyncEnumerator,
                    AsyncEnumerator<TInner> innerAsyncEnumerator,
                    TOuterKeySelector outerKeySelector,
                    TInnerKeySelector innerKeySelector,
                    TEqualityComparer comparer)
            ...
            internal static AsyncEnumerable<(TOuter Outer, TInner Inner)> Join<TOuter, TInner, TOuterKeySelector, TInnerKeySelector, TEqualityComparer>(
                ...
                where TEqualityComparer : IEqualityComparer<TKey>
                => AsyncEnumerable<(TOuter Outer, TInner Inner)>.Create(
                    new ConfiguredJoinIterator<TOuter, TInner, TOuterKeySelector, TInnerKeySelector, TEqualityComparer>(configuredOuterAsyncEnumerator, innerAsyncEnumerator, outerKeySelector, innerKeySelector, comparer));
