...
namespace Proto.Promises.Linq
{
    ...
    partial class AsyncEnumerable
    {
        ...
        /// <returns>An async-enumerable sequence that has elements of <see cref="ValueTuple{T1, T2}"/> of each outer element and the inner elements of the same key, that are obtained by performing a grouped join on two sequences.</returns>
        /// <exception cref="ArgumentNullException"><paramref name="outerKeySelector"/> or <paramref name="innerKeySelector"/> is null.</exception>
        public static AsyncEnumerable<(TOuter Outer, TempCollection<TInner> InnerElements)> GroupJoin<TOuter, TInner, TKey>(this ConfiguredAsyncEnumerable<TOuter> configuredOuter,
            AsyncEnumerable<TInner> inner,
            Func<TOuter, TKey> outerKeySelector,
            Func<TInner, TKey> innerKeySelector)
        ...
        /// <returns>An async-enumerable sequence that has elements of <see cref="ValueTuple{T1, T2}"/> of each outer element and the inner elements of the same key, that are obtained by performing a grouped join on two sequences.</returns>
        /// <exception cref="ArgumentNullException"><paramref name="outerKeySelector"/> or <paramref name="innerKeySelector"/> is null.</exception>
        public static AsyncEnumerable<(TOuter Outer, TempCollection<TInner> InnerElements)> GroupJoin<TOuter, TInner, TKey, TOuterCapture>(this ConfiguredAsyncEnumerable<TOuter> configuredOuter,
            AsyncEnumerable<TInner> inner,
            TOuterCapture outerCaptureValue,
            Func<TOuterCapture, TOuter, TKey> outerKeySelector,
            Func<TInner, TKey> innerKeySelector)
        ...
        /// <returns>An async-enumerable sequence that has elements of <see cref="ValueTuple{T1, T2}"/> of each outer element and the inner elements of the same key, that are obtained by performing a grouped join on two sequences.</returns>
        /// <exception cref="ArgumentNullException"><paramref name="outerKeySelector"/> or <paramref name="innerKeySelector"/> is null.</exception>
        public static AsyncEnumerable<(TOuter Outer, TempCollection<TInner> InnerElements)> GroupJoin<TOuter, TInner, TKey, TInnerCapture>(this ConfiguredAsyncEnumerable<TOuter> configuredOuter,
            AsyncEnumerable<TInner> inner,
            Func<TOuter, TKey> outerKeySelector,
            TInnerCapture innerCaptureValue,
            Func<TInnerCapture, TInner, TKey> innerKeySelector)
        ...
        /// <returns>An async-enumerable sequence that has elements of <see cref="ValueTuple{T1, T2}"/> of each outer element and the inner elements of the same key, that are obtained by performing a grouped join on two sequences.</returns>
        /// <exception cref="ArgumentNullException"><paramref name="outerKeySelector"/> or <paramref name="innerKeySelector"/> is null.</exception>
        public static AsyncEnumerable<(TOuter Outer, TempCollection<TInner> InnerElements)> GroupJoin<TOuter, TInner, TKey, TOuterCapture, TInnerCapture>(this ConfiguredAsyncEnumerable<TOuter> configuredOuter,
            AsyncEnumerable<TInner> inner,
            TOuterCapture outerCaptureValue,
            Func<TOuterCapture, TOuter, TKey> outerKeySelector,
            TInnerCapture innerCaptureValue,
        ...
        /// <returns>An async-enumerable sequence that has elements of <see cref="ValueTuple{T1, T2}"/> of each outer element and the inner elements of the same key, that are obtained by performing a grouped join on two sequences.</returns>
        /// <exception cref="ArgumentNullException"><paramref name="outerKeySelector"/> or <paramref name="innerKeySelector"/> or <paramref name="comparer"/> is null.</exception>
        public static AsyncEnumerable<(TOuter Outer, TempCollection<TInner> InnerElements)> GroupJoin<TOuter, TInner, TKey, TEqualityComparer>(this ConfiguredAsyncEnumerable<TOuter> configuredOuter,
            AsyncEnumerable<TInner> inner,
            Func<TOuter, TKey> outerKeySelector,
            Func<TInner, TKey> innerKeySelector,
            TEqualityComparer comparer)
        ...
        /// <returns>An async-enumerable sequence that has elements of <see cref="ValueTuple{T1, T2}"/> of each outer element and the inner elements of the same key, that are obtained by performing a grouped join on two sequences.</returns>
        /// <exception cref="ArgumentNullException"><paramref name="outerKeySelector"/> or <paramref name="innerKeySelector"/> is null.</exception>
        public static AsyncEnumerable<(TOuter Outer, TempCollection<TInner> InnerElements)> GroupJoin<TOuter, TInner, TKey, TOuterCapture, TEqualityComparer>(this ConfiguredAsyncEnumerable<TOuter> configuredOuter,
            AsyncEnumerable<TInner> inner,
            TOuterCapture outerCaptureValue,
            Func<TOuterCapture, TOuter, TKey> outerKeySelector,
            Func<TInner, TKey> innerKeySelector,
        ...
        /// <returns>An async-enumerable sequence that has elements of <see cref="ValueTuple{T1, T2}"/> of each outer element and the inner elements of the same key, that are obtained by performing a grouped join on two sequences.</returns>
        /// <exception cref="ArgumentNullException"><paramref name="outerKeySelector"/> or <paramref name="innerKeySelector"/> is null.</exception>
        public static AsyncEnumerable<(TOuter Outer, TempCollection<TInner> InnerElements)> GroupJoin<TOuter, TInner, TKey, TInnerCapture, TEqualityComparer>(this ConfiguredAsyncEnumerable<TOuter> configuredOuter,
            AsyncEnumerable<TInner> inner,
            Func<TOuter, TKey> outerKeySelector,
            TInnerCapture innerCaptureValue,
            Func<TInnerCapture, TInner, TKey> innerKeySelector,
        ...
        /// <returns>An async-enumerable sequence that has elements of <see cref="ValueTuple{T1, T2}"/> of each outer element and the inner elements of the same key, that are obtained by performing a grouped join on two sequences.</returns>
        /// <exception cref="ArgumentNullException"><paramref name="outerKeySelector"/> or <paramref name="innerKeySelector"/> is null.</exception>
        public static AsyncEnumerable<(TOuter Outer, TempCollection<TInner> InnerElements)> GroupJoin<TOuter, TInner, TKey, TOuterCapture, TInnerCapture, TEqualityComparer>(this ConfiguredAsyncEnumerable<TOuter> configuredOuter,
            AsyncEnumerable<TInner> inner,
            TOuterCapture outerCaptureValue,
            Func<TOuterCapture, TOuter, TKey> outerKeySelector,
            TInnerCapture innerCaptureValue,
