...
namespace Proto.Promises.Linq
{
    partial class AsyncEnumerable
    {
        ...
        {
            internal static async Promise<TSource> MinByAsync<TSource, TKeySelector, TComparer>(AsyncEnumerator<TSource> asyncEnumerator, TKeySelector keySelector, TComparer comparer, CancelationToken cancelationToken)
            ...
            internal static async Promise<TSource> MinByAsync<TSource, TKeySelector, TComparer>(ConfiguredAsyncEnumerable<TSource>.Enumerator asyncEnumerator, TKeySelector keySelector, TComparer comparer, CancelationToken cancelationToken)
                where TComparer : IComparer<TKey>
                where TKeySelector : IFunc<TSource, CancelationToken, Promise<TKey>>
            {
                try
            ...
            where TComparer : IComparer<TKey>
        {
            ...
            return MinByHelper<TKey>.MinByAsync(source.GetAsyncEnumerator(cancelationToken), DelegateWrapper.Create(keySelector), comparer, cancelationToken);
        }
            ...
            where TComparer : IComparer<TKey>
        {
            ...
            return MinByHelper<TKey>.MinByAsync(source.GetAsyncEnumerator(cancelationToken), DelegateWrapper.Create(captureValue, keySelector), comparer, cancelationToken);
        }
        ...
        /// <para/> If <paramref name="keySelector"/> results in <see langword="null"/> for all elements, the first element will be returned.
        /// </remarks>
        public static Promise<TSource> MinByAsync<TSource, TKey>(this AsyncEnumerable<TSource> source, Func<TSource, CancelationToken, Promise<TKey>> keySelector, CancelationToken cancelationToken = default)
            => MinByAsync(source, keySelector, Comparer<TKey>.Default, cancelationToken);
        ...
        /// <para/> If <paramref name="keySelector"/> results in <see langword="null"/> for all elements, the first element will be returned.
        /// </remarks>
        public static Promise<TSource> MinByAsync<TSource, TKey, TComparer>(this AsyncEnumerable<TSource> source, Func<TSource, CancelationToken, Promise<TKey>> keySelector, TComparer comparer, CancelationToken cancelationToken = default)
            where TComparer : IComparer<TKey>
        {
            ValidateArgument(keySelector, nameof(keySelector), 1);
            ValidateArgument(comparer, nameof(comparer), 1);
        ...
        /// <para/> If <paramref name="keySelector"/> results in <see langword="null"/> for all elements, the first element will be returned.
        /// </remarks>
        public static Promise<TSource> MinByAsync<TSource, TKey, TCapture>(this AsyncEnumerable<TSource> source, TCapture captureValue, Func<TCapture, TSource, CancelationToken, Promise<TKey>> keySelector, CancelationToken cancelationToken = default)
            => MinByAsync(source, captureValue, keySelector, Comparer<TKey>.Default, cancelationToken);
        ...
        /// <para/> If <paramref name="keySelector"/> results in <see langword="null"/> for all elements, the first element will be returned.
        /// </remarks>
        public static Promise<TSource> MinByAsync<TSource, TKey, TCapture, TComparer>(this AsyncEnumerable<TSource> source, TCapture captureValue, Func<TCapture, TSource, CancelationToken, Promise<TKey>> keySelector, TComparer comparer, CancelationToken cancelationToken = default)
            where TComparer : IComparer<TKey>
        {
            ValidateArgument(keySelector, nameof(keySelector), 1);
            ValidateArgument(comparer, nameof(comparer), 1);
            ...
            where TComparer : IComparer<TKey>
        {
            ...
            return MinByHelper<TKey>.MinByAsync(configuredSource.GetAsyncEnumerator(), DelegateWrapper.Create(keySelector), comparer, configuredSource.CancelationToken);
        }
            ...
            where TComparer : IComparer<TKey>
        {
            ...
            return MinByHelper<TKey>.MinByAsync(configuredSource.GetAsyncEnumerator(), DelegateWrapper.Create(captureValue, keySelector), comparer, configuredSource.CancelationToken);
        }
        ...
        /// <para/> If <paramref name="keySelector"/> results in <see langword="null"/> for all elements, the first element will be returned.
        /// </remarks>
        public static Promise<TSource> MinByAsync<TSource, TKey>(this in ConfiguredAsyncEnumerable<TSource> configuredSource, Func<TSource, CancelationToken, Promise<TKey>> keySelector)
            => MinByAsync(configuredSource, keySelector, Comparer<TKey>.Default);
        ...
        /// <para/> If <paramref name="keySelector"/> results in <see langword="null"/> for all elements, the first element will be returned.
        /// </remarks>
        public static Promise<TSource> MinByAsync<TSource, TKey, TComparer>(this in ConfiguredAsyncEnumerable<TSource> configuredSource, Func<TSource, CancelationToken, Promise<TKey>> keySelector, TComparer comparer)
            where TComparer : IComparer<TKey>
        {
            ValidateArgument(keySelector, nameof(keySelector), 1);
            ValidateArgument(comparer, nameof(comparer), 1);
        ...
        /// <para/> If <paramref name="keySelector"/> results in <see langword="null"/> for all elements, the first element will be returned.
        /// </remarks>
        public static Promise<TSource> MinByAsync<TSource, TKey, TCapture>(this in ConfiguredAsyncEnumerable<TSource> configuredSource, TCapture captureValue, Func<TCapture, TSource, CancelationToken, Promise<TKey>> keySelector)
            => MinByAsync(configuredSource, captureValue, keySelector, Comparer<TKey>.Default);
        ...
        /// <para/> If <paramref name="keySelector"/> results in <see langword="null"/> for all elements, the first element will be returned.
        /// </remarks>
        public static Promise<TSource> MinByAsync<TSource, TKey, TCapture, TComparer>(this in ConfiguredAsyncEnumerable<TSource> configuredSource, TCapture captureValue, Func<TCapture, TSource, CancelationToken, Promise<TKey>> keySelector, TComparer comparer)
            where TComparer : IComparer<TKey>
        {
            ValidateArgument(keySelector, nameof(keySelector), 1);
            ValidateArgument(comparer, nameof(comparer), 1);
