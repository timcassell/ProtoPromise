...
namespace Proto.Promises.Linq
{
    partial class AsyncEnumerable
    {
        ...
        /// </remarks>
        public static Promise<TSource> MaxByAsync<TSource, TKey>(this AsyncEnumerable<TSource> source, Func<TSource, TKey> keySelector, CancelationToken cancelationToken = default)
            => MaxByAsync(source, keySelector, Comparer<TKey>.Default, cancelationToken);

        /// <summary>
        /// Asynchronously returns the maximum element of an async-enumerable sequence according to the specified key selector function using the specified comparer.
        /// </summary>
        /// <typeparam name="TSource">The type of the elements of <paramref name="source"/>.</typeparam>
        /// <typeparam name="TKey">The type of key to compare elements by.</typeparam>
        ...
        /// <para/> If <paramref name="keySelector"/> results in <see langword="null"/> for all elements, the first element will be returned.
        /// </remarks>
        public static Promise<TSource> MaxByAsync<TSource, TKey, TComparer>(this AsyncEnumerable<TSource> source, Func<TSource, TKey> keySelector, TComparer comparer, CancelationToken cancelationToken = default)
        ...
        /// <para/> If <paramref name="keySelector"/> results in <see langword="null"/> for all elements, the first element will be returned.
        /// </remarks>
        public static Promise<TSource> MaxByAsync<TSource, TKey, TCapture>(this AsyncEnumerable<TSource> source, TCapture captureValue, Func<TCapture, TSource, TKey> keySelector, CancelationToken cancelationToken = default)
        ...
        /// <para/> If <paramref name="keySelector"/> results in <see langword="null"/> for all elements, the first element will be returned.
        /// </remarks>
        public static Promise<TSource> MaxByAsync<TSource, TKey, TCapture, TComparer>(this AsyncEnumerable<TSource> source, TCapture captureValue, Func<TCapture, TSource, TKey> keySelector, TComparer comparer, CancelationToken cancelationToken = default)
            where TComparer : IComparer<TKey>
        {
            ValidateArgument(keySelector, nameof(keySelector), 1);
            ValidateArgument(comparer, nameof(comparer), 1);
        ...
        /// <summary>
        /// Asynchronously returns the maximum element of a configured async-enumerable sequence according to the specified key selector function using the default comparer.
        /// </summary>
        /// <typeparam name="TSource">The type of the elements of <paramref name="configuredSource"/>.</typeparam>
        /// <typeparam name="TKey">The type of key to compare elements by.</typeparam>
        /// <param name="configuredSource">The configured async-enumerable sequence to return the maximum element of.</param>
        /// <param name="keySelector">A function to extract the key for each element.</param>
        /// <returns>A <see cref="Promise{T}"/> resulting in the maximum element.</returns>
        /// <exception cref="ArgumentNullException"><paramref name="keySelector"/> is <see langword="null"/>.</exception>
        ...
        /// <para/> If <paramref name="keySelector"/> results in <see langword="null"/> for all elements, the first element will be returned.
        /// </remarks>
        public static Promise<TSource> MaxByAsync<TSource, TKey>(this in ConfiguredAsyncEnumerable<TSource> configuredSource, Func<TSource, TKey> keySelector)
            => MaxByAsync(configuredSource, keySelector, Comparer<TKey>.Default);

        /// <summary>
        /// Asynchronously returns the maximum element of a configured async-enumerable sequence according to the specified key selector function using the specified comparer.
        /// </summary>
        /// <typeparam name="TSource">The type of the elements of <paramref name="configuredSource"/>.</typeparam>
        /// <typeparam name="TKey">The type of key to compare elements by.</typeparam>
        /// <typeparam name="TComparer">The type of the comparer.</typeparam>
        ...
        /// <para/> If <paramref name="keySelector"/> results in <see langword="null"/> for all elements, the first element will be returned.
        /// </remarks>
        public static Promise<TSource> MaxByAsync<TSource, TKey, TComparer>(this in ConfiguredAsyncEnumerable<TSource> configuredSource, Func<TSource, TKey> keySelector, TComparer comparer)
            where TComparer : IComparer<TKey>
        {
            ValidateArgument(keySelector, nameof(keySelector), 1);
            ValidateArgument(comparer, nameof(comparer), 1);
        ...
        /// <para/> If <paramref name="keySelector"/> results in <see langword="null"/> for all elements, the first element will be returned.
        /// </remarks>
        public static Promise<TSource> MaxByAsync<TSource, TKey, TCapture>(this in ConfiguredAsyncEnumerable<TSource> configuredSource, TCapture captureValue, Func<TCapture, TSource, TKey> keySelector)
        ...
        /// <para/> If <paramref name="keySelector"/> results in <see langword="null"/> for all elements, the first element will be returned.
        /// </remarks>
        public static Promise<TSource> MaxByAsync<TSource, TKey, TCapture, TComparer>(this in ConfiguredAsyncEnumerable<TSource> configuredSource, TCapture captureValue, Func<TCapture, TSource, TKey> keySelector, TComparer comparer)
            where TComparer : IComparer<TKey>
        {
            ValidateArgument(keySelector, nameof(keySelector), 1);
            ValidateArgument(comparer, nameof(comparer), 1);
