    ...
    public class PromiseMergeGroupTests
    {
            ...
            [Values] bool alreadyComplete4)
        {
            using (var cancelationSource = CancelationSource.New())
            {
                ...
                mergeGroup
                    ...
                    .Add(TestHelper.BuildPromise(completeType3, alreadyComplete3, expectedException, out var tryCompleter3))
                    .Add(TestHelper.BuildPromise(completeType4, alreadyComplete4, value2, expectedException, out var tryCompleter4))
                    .WaitAsync()
                    .ContinueWith(result =>
                    {
                        completed = true;
            ...
            [Values] bool alreadyComplete4)
        {
            using (var cancelationSource = CancelationSource.New())
            {
                ...
                mergeGroup
                    .Add(TestHelper.BuildPromise(completeType1, alreadyComplete1, value1, expectedException, out var tryCompleter1))
                    .Add(TestHelper.BuildPromise(completeType2, alreadyComplete2, expectedException, out var tryCompleter2))
                    .Add(TestHelper.BuildPromise(completeType3, alreadyComplete3, value2, expectedException, out var tryCompleter3))
                    .Add(TestHelper.BuildPromise(completeType4, alreadyComplete4, value3, expectedException, out var tryCompleter4))
                    .WaitAsync()
                    .ContinueWith(result =>
                    {
                        completed = true;
            ...
            [Values(CompleteType.Resolve)] CompleteType completeType7)
        {
            using (var cancelationSource = CancelationSource.New())
            {
                ...
                mergeGroup
                    .Add(TestHelper.BuildPromise(completeType1, alreadyComplete1, value1, expectedException, out var tryCompleter1))
                    .Add(TestHelper.BuildPromise(completeType2, alreadyComplete2, value2, expectedException, out var tryCompleter2))
                    .Add(TestHelper.BuildPromise(completeType3, alreadyComplete3, value3, expectedException, out var tryCompleter3))
                    .Add(TestHelper.BuildPromise(completeType4, alreadyComplete4Through7, value4, expectedException, out var tryCompleter4))
                    .Add(TestHelper.BuildPromise(completeType5, alreadyComplete4Through7, value5, expectedException, out var tryCompleter5))
                    .Add(TestHelper.BuildPromise(completeType6, alreadyComplete4Through7, value6, expectedException, out var tryCompleter6))
                    .Add(TestHelper.BuildPromise(completeType7, alreadyComplete4Through7, value7, expectedException, out var tryCompleter7))
                    .WaitAsync()
                    .ContinueWith(result =>
                    {
                        completed = true;
            ...
            [Values] bool alreadyComplete8)
        {
            using (var cancelationSource = CancelationSource.New())
            {
                ...
                mergeGroup
                    .Add(TestHelper.BuildPromise(completeType1, alreadyComplete1, value1, expectedException, out var tryCompleter1))
                    .Add(TestHelper.BuildPromise(completeType2, alreadyComplete2Through6, value2, expectedException, out var tryCompleter2))
                    .Add(TestHelper.BuildPromise(completeType3, alreadyComplete2Through6, value3, expectedException, out var tryCompleter3))
                    .Add(TestHelper.BuildPromise(completeType4, alreadyComplete2Through6, value4, expectedException, out var tryCompleter4))
                    .Add(TestHelper.BuildPromise(completeType5, alreadyComplete2Through6, value5, expectedException, out var tryCompleter5))
                    .Add(TestHelper.BuildPromise(completeType6, alreadyComplete2Through6, value6, expectedException, out var tryCompleter6))
                    .Add(TestHelper.BuildPromise(completeType7, alreadyComplete7, value7, expectedException, out var tryCompleter7))
            ...
            [Values] bool alreadyComplete4)
        {
            using (var cancelationSource = CancelationSource.New())
            {
                ...
                var completeValues = new[]
                {
                    (completeType1, alreadyComplete1),
                    (completeType2, alreadyComplete2),
                    (completeType3, alreadyComplete3),
                    (completeType4, alreadyComplete4)
                };
                ...
                mergeGroup
                    ...
                    .Add(TestHelper.BuildPromise(completeType3, alreadyComplete3, expectedException, groupCancelationToken, out var tryCompleter3))
                    .Add(TestHelper.BuildPromise(completeType4, alreadyComplete4, value2, expectedException, groupCancelationToken, out var tryCompleter4))
                    .WaitAsync()
                    .ContinueWith(result =>
                    {
                        completed = true;
            ...
            [Values(CompleteType.Resolve)] CompleteType completeType7)
        {
            using (var cancelationSource = CancelationSource.New())
            {
                ...
                var completeValues = new[]
                {
                    ...
                    (completeType2, alreadyComplete2),
                    (completeType3, alreadyComplete3),
                    (completeType4, alreadyComplete4Through7),
                    (completeType5, alreadyComplete4Through7),
                    (completeType6, alreadyComplete4Through7),
                    (completeType7, alreadyComplete4Through7)
                };

                mergeGroup
                    .Add(TestHelper.BuildPromise(completeType1, alreadyComplete1, value1, expectedException, groupCancelationToken, out var tryCompleter1))
                    .Add(TestHelper.BuildPromise(completeType2, alreadyComplete2, value2, expectedException, groupCancelationToken, out var tryCompleter2))
                    .Add(TestHelper.BuildPromise(completeType3, alreadyComplete3, value3, expectedException, groupCancelationToken, out var tryCompleter3))
                    .Add(TestHelper.BuildPromise(completeType4, alreadyComplete4Through7, value4, expectedException, groupCancelationToken, out var tryCompleter4))
                    .Add(TestHelper.BuildPromise(completeType5, alreadyComplete4Through7, value5, expectedException, groupCancelationToken, out var tryCompleter5))
                    .Add(TestHelper.BuildPromise(completeType6, alreadyComplete4Through7, value6, expectedException, groupCancelationToken, out var tryCompleter6))
                    .Add(TestHelper.BuildPromise(completeType7, alreadyComplete4Through7, value7, expectedException, groupCancelationToken, out var tryCompleter7))
                    .WaitAsync()
                    .ContinueWith(result =>
                    {
                        completed = true;
            ...
            [Values] bool alreadyComplete8)
        {
            using (var cancelationSource = CancelationSource.New())
            {
                ...
                {
                    (completeType1, alreadyComplete1),
                    (completeType2, alreadyComplete2Through6),
                    (completeType3, alreadyComplete2Through6),
                    (completeType4, alreadyComplete2Through6),
                    (completeType5, alreadyComplete2Through6),
                    (completeType6, alreadyComplete2Through6),
                    (completeType7, alreadyComplete7),
                    (completeType8, alreadyComplete8)
                };

                mergeGroup
                    .Add(TestHelper.BuildPromise(completeType1, alreadyComplete1, value1, expectedException, groupCancelationToken, out var tryCompleter1))
                    .Add(TestHelper.BuildPromise(completeType2, alreadyComplete2Through6, value2, expectedException, groupCancelationToken, out var tryCompleter2))
                    .Add(TestHelper.BuildPromise(completeType3, alreadyComplete2Through6, value3, expectedException, groupCancelationToken, out var tryCompleter3))
                    .Add(TestHelper.BuildPromise(completeType4, alreadyComplete2Through6, value4, expectedException, groupCancelationToken, out var tryCompleter4))
                    .Add(TestHelper.BuildPromise(completeType5, alreadyComplete2Through6, value5, expectedException, groupCancelationToken, out var tryCompleter5))
                    .Add(TestHelper.BuildPromise(completeType6, alreadyComplete2Through6, value6, expectedException, groupCancelationToken, out var tryCompleter6))
                    .Add(TestHelper.BuildPromise(completeType7, alreadyComplete7, value7, expectedException, groupCancelationToken, out var tryCompleter7))
