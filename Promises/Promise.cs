...
namespace Proto.Promises
{
    ...
    public abstract partial class Promise : IRetainable
    {
        ...
        public Promise Then(Action onResolved)
        {
            ...
            var promise = Internal.PromiseVoidResolve0.GetOrCreate(onResolved);
        ...
        public Promise<TResult> Then<TResult>(Func<TResult> onResolved)
        {
            ...
            var promise = Internal.PromiseVoidResolve<TResult>.GetOrCreate(onResolved);
            HookupNewPromise(promise);
            return promise;
        }
        ...
        public Promise Then(Func<Promise> onResolved)
        {
            ...
            var promise = Internal.PromiseVoidResolvePromise0.GetOrCreate(onResolved);
            HookupNewPromise(promise);
            return promise;
        }
        ...
        public Promise<TResult> Then<TResult>(Func<Promise<TResult>> onResolved)
        {
            ...
            var promise = Internal.PromiseVoidResolvePromise<TResult>.GetOrCreate(onResolved);
            HookupNewPromise(promise);
            return promise;
        }
        #endregion
