    ...
    public abstract partial class Promise
    {
        ...
        public Promise Then<TCaptureResolve>(TCaptureResolve resolveCaptureValue, Action<TCaptureResolve> onResolved, CancelationToken cancelationToken = default(CancelationToken))
        {
            ...
            if (cancelationToken.CanBeCanceled)
            {
                ...
                promise.resolver = new InternalProtected.DelegateCaptureVoidVoidCancel<TCaptureResolve>(ref resolveCaptureValue, onResolved, cancelationToken.RegisterInternal(promise));
        ...
        public Promise<TResult> Then<TCaptureResolve, TResult>(TCaptureResolve resolveCaptureValue, Func<TCaptureResolve, TResult> onResolved, CancelationToken cancelationToken = default(CancelationToken))
        {
            ...
            if (cancelationToken.CanBeCanceled)
            {
                ...
                promise.resolver = new InternalProtected.DelegateCaptureVoidResultCancel<TCaptureResolve, TResult>(ref resolveCaptureValue, onResolved, cancelationToken.RegisterInternal(promise));
                MaybeHookupNewPromise(promise);
                return promise;
            }
            else
        ...
        public Promise Then<TCaptureResolve>(TCaptureResolve resolveCaptureValue, Func<TCaptureResolve, Promise> onResolved, CancelationToken cancelationToken = default(CancelationToken))
        {
            ...
            if (cancelationToken.CanBeCanceled)
            {
                ...
                promise.resolver = new InternalProtected.DelegateCaptureVoidPromiseCancel<TCaptureResolve>(ref resolveCaptureValue, onResolved, cancelationToken.RegisterInternal(promise));
                MaybeHookupNewPromise(promise);
                return promise;
            }
            else
        ...
        public Promise<TResult> Then<TCaptureResolve, TResult>(TCaptureResolve resolveCaptureValue, Func<TCaptureResolve, Promise<TResult>> onResolved, CancelationToken cancelationToken = default(CancelationToken))
        {
            ...
            if (cancelationToken.CanBeCanceled)
            {
                ...
                promise.resolver = new InternalProtected.DelegateCaptureVoidPromiseTCancel<TCaptureResolve, TResult>(ref resolveCaptureValue, onResolved, cancelationToken.RegisterInternal(promise));
                MaybeHookupNewPromise(promise);
                return promise;
            }
            else
        ...
        public Promise ContinueWith<TCapture>(TCapture continueCaptureValue, Action<TCapture, ResultContainer> onContinue, CancelationToken cancelationToken = default(CancelationToken))
        {
            ...
            if (cancelationToken.CanBeCanceled)
            {
                ...
                promise.continuer = new InternalProtected.DelegateContinueCaptureVoidVoidCancel<TCapture>(ref continueCaptureValue, onContinue, cancelationToken.RegisterInternal(promise));
                HookupNewPromise(promise);
                return promise;
            }
            else
        ...
        public Promise<TResult> ContinueWith<TCapture, TResult>(TCapture continueCaptureValue, Func<TCapture, ResultContainer, TResult> onContinue, CancelationToken cancelationToken = default(CancelationToken))
        {
            ...
            if (cancelationToken.CanBeCanceled)
            {
                ...
                promise.continuer = new InternalProtected.DelegateContinueCaptureVoidResultCancel<TCapture, TResult>(ref continueCaptureValue, onContinue, cancelationToken.RegisterInternal(promise));
                HookupNewPromise(promise);
                return promise;
            }
            else
    ...
    public abstract partial class Promise<T> : Promise
    {
        ...
        public Promise Then<TCaptureResolve>(TCaptureResolve resolveCaptureValue, Action<TCaptureResolve, T> onResolved, CancelationToken cancelationToken = default(CancelationToken))
        {
            ...
            if (cancelationToken.CanBeCanceled)
            {
                ...
                promise.resolver = new InternalProtected.DelegateCaptureArgVoidCancel<TCaptureResolve, T>(ref resolveCaptureValue, onResolved, cancelationToken.RegisterInternal(promise));
                MaybeHookupNewPromise(promise);
                return promise;
            }
            else
        ...
        public Promise<TResult> Then<TCaptureResolve, TResult>(TCaptureResolve resolveCaptureValue, Func<TCaptureResolve, T, TResult> onResolved, CancelationToken cancelationToken = default(CancelationToken))
        {
            ...
            if (cancelationToken.CanBeCanceled)
            {
                ...
                promise.resolver = new InternalProtected.DelegateCaptureArgResultCancel<TCaptureResolve, T, TResult>(ref resolveCaptureValue, onResolved, cancelationToken.RegisterInternal(promise));
                MaybeHookupNewPromise(promise);
                return promise;
            }
            else
        ...
        public Promise Then<TCaptureResolve>(TCaptureResolve resolveCaptureValue, Func<TCaptureResolve, T, Promise> onResolved, CancelationToken cancelationToken = default(CancelationToken))
        {
            ...
            if (cancelationToken.CanBeCanceled)
            {
                ...
                promise.resolver = new InternalProtected.DelegateCaptureArgPromiseCancel<TCaptureResolve, T>(ref resolveCaptureValue, onResolved, cancelationToken.RegisterInternal(promise));
                MaybeHookupNewPromise(promise);
                return promise;
            }
            else
        ...
        public Promise<TResult> Then<TCaptureResolve, TResult>(TCaptureResolve resolveCaptureValue, Func<TCaptureResolve, T, Promise<TResult>> onResolved, CancelationToken cancelationToken = default(CancelationToken))
        {
            ...
            if (cancelationToken.CanBeCanceled)
            {
                ...
                promise.resolver = new InternalProtected.DelegateCaptureArgPromiseTCancel<TCaptureResolve, T, TResult>(ref resolveCaptureValue, onResolved, cancelationToken.RegisterInternal(promise));
                MaybeHookupNewPromise(promise);
                return promise;
            }
            else
        ...
        public Promise ContinueWith<TCapture>(TCapture continueCaptureValue, Action<TCapture, ResultContainer> onContinue, CancelationToken cancelationToken = default(CancelationToken))
        {
            ...
            if (cancelationToken.CanBeCanceled)
            {
                ...
                promise.continuer = new InternalProtected.DelegateContinueCaptureArgVoidCancel<TCapture, T>(ref continueCaptureValue, onContinue, cancelationToken.RegisterInternal(promise));
                HookupNewPromise(promise);
                return promise;
            }
            else
        ...
        public Promise<TResult> ContinueWith<TCapture, TResult>(TCapture continueCaptureValue, Func<TCapture, ResultContainer, TResult> onContinue, CancelationToken cancelationToken = default(CancelationToken))
        {
            ...
            if (cancelationToken.CanBeCanceled)
            {
                ...
                promise.continuer = new InternalProtected.DelegateContinueCaptureArgResultCancel<TCapture, T, TResult>(ref continueCaptureValue, onContinue, cancelationToken.RegisterInternal(promise));
                HookupNewPromise(promise);
                return promise;
            }
            else
