...
namespace System
{
        ...
        : IEquatable<ValueTuple<T1>>, IStructuralEquatable, IStructuralComparable, IComparable, IComparable<ValueTuple<T1>>, IValueTupleInternal, ITuple
    {
        ...
        public override int GetHashCode()
        {
            return Item1 == null ? 0 : Item1.GetHashCode();
        }
        ...
        public override string ToString()
        {
            return "(" + (Item1 == null ? null : Item1.ToString()) + ")";
        }
        ...
        : IEquatable<ValueTuple<T1, T2>>, IStructuralEquatable, IStructuralComparable, IComparable, IComparable<ValueTuple<T1, T2>>, IValueTupleInternal, ITuple
    {
        ...
        public override int GetHashCode()
        {
            return ValueTuple.CombineHashCodes(Item1 == null ? 0 : Item1.GetHashCode(),
                                               Item2 == null ? 0 : Item2.GetHashCode());
        }
        ...
        public override string ToString()
        {
            return "(" + (Item1 == null ? null : Item1.ToString()) + ", " + (Item2 == null ? null : Item2.ToString()) + ")";
        }
        ...
        : IEquatable<ValueTuple<T1, T2, T3>>, IStructuralEquatable, IStructuralComparable, IComparable, IComparable<ValueTuple<T1, T2, T3>>, IValueTupleInternal, ITuple
    {
        ...
        public override string ToString()
        {
            return "(" + (Item1 == null ? null : Item1.ToString()) + ", " + (Item2 == null ? null : Item2.ToString()) + ", " + (Item3 == null ? null : Item3.ToString()) + ")";
        }
        ...
        : IEquatable<ValueTuple<T1, T2, T3, T4>>, IStructuralEquatable, IStructuralComparable, IComparable, IComparable<ValueTuple<T1, T2, T3, T4>>, IValueTupleInternal, ITuple
    {
        ...
        public override int GetHashCode()
        {
            return ValueTuple.CombineHashCodes(Item1 == null ? 0 : Item1.GetHashCode(),
                                               Item2 == null ? 0 : Item2.GetHashCode(),
                                               Item3 == null ? 0 : Item3.GetHashCode(),
                                               Item4 == null ? 0 : Item4.GetHashCode());
        }
        ...
        {
            return "(" + (Item1 == null ? null : Item1.ToString()) + ", " + (Item2 == null ? null : Item2.ToString())
                + ", " + (Item3 == null ? null : Item3.ToString()) + ", " + (Item4 == null ? null : Item4.ToString()) + ")";
        }
        ...
        : IEquatable<ValueTuple<T1, T2, T3, T4, T5>>, IStructuralEquatable, IStructuralComparable, IComparable, IComparable<ValueTuple<T1, T2, T3, T4, T5>>, IValueTupleInternal, ITuple
    {
        ...
        public override int GetHashCode()
        {
            return ValueTuple.CombineHashCodes(Item1 == null ? 0 : Item1.GetHashCode(),
                                               ...
                                               Item3 == null ? 0 : Item3.GetHashCode(),
                                               Item4 == null ? 0 : Item4.GetHashCode(),
                                               Item5 == null ? 0 : Item5.GetHashCode());
        }
        ...
        {
            return "(" + (Item1 == null ? null : Item1.ToString()) + ", " + (Item2 == null ? null : Item2.ToString())
                + ", " + (Item3 == null ? null : Item3.ToString()) + ", " + (Item4 == null ? null : Item4.ToString()) + ", " + (Item5 == null ? null : Item5.ToString()) + ")";
        }
        ...
        : IEquatable<ValueTuple<T1, T2, T3, T4, T5, T6>>, IStructuralEquatable, IStructuralComparable, IComparable, IComparable<ValueTuple<T1, T2, T3, T4, T5, T6>>, IValueTupleInternal, ITuple
    {
        ...
        {
            return "(" + (Item1 == null ? null : Item1.ToString()) + ", " + (Item2 == null ? null : Item2.ToString()) + ", " + (Item3 == null ? null : Item3.ToString())
                + ", " + (Item4 == null ? null : Item4.ToString()) + ", " + (Item5 == null ? null : Item5.ToString()) + ", " + (Item6 == null ? null : Item6.ToString()) + ")";
        }
    ...
    where TRest : struct
    {
        ...
        public override int GetHashCode()
        {
            ...
            {
                case 1:
                    return ValueTuple.CombineHashCodes(Item7 == null ? 0 : Item7.GetHashCode(),
                                                       rest.GetHashCode());
                case 2:
                    return ValueTuple.CombineHashCodes(Item6 == null ? 0 : Item6.GetHashCode(),
                                                       Item7 == null ? 0 : Item7.GetHashCode(),
                                                       rest.GetHashCode());
                case 3:
                    return ValueTuple.CombineHashCodes(Item5 == null ? 0 : Item5.GetHashCode(),
                                                       Item6 == null ? 0 : Item6.GetHashCode(),
                                                       Item7 == null ? 0 : Item7.GetHashCode(),
                                                       rest.GetHashCode());
                case 4:
                    return ValueTuple.CombineHashCodes(Item4 == null ? 0 : Item4.GetHashCode(),
                                                       Item5 == null ? 0 : Item5.GetHashCode(),
                                                       Item6 == null ? 0 : Item6.GetHashCode(),
                                                       Item7 == null ? 0 : Item7.GetHashCode(),
                                                       rest.GetHashCode());
                case 5:
                    return ValueTuple.CombineHashCodes(Item3 == null ? 0 : Item3.GetHashCode(),
                                                       Item4 == null ? 0 : Item4.GetHashCode(),
                                                       Item5 == null ? 0 : Item5.GetHashCode(),
                                                       Item6 == null ? 0 : Item6.GetHashCode(),
                                                       Item7 == null ? 0 : Item7.GetHashCode(),
                                                       rest.GetHashCode());
                case 6:
                    return ValueTuple.CombineHashCodes(Item2 == null ? 0 : Item2.GetHashCode(),
                                                       Item3 == null ? 0 : Item3.GetHashCode(),
                                                       Item4 == null ? 0 : Item4.GetHashCode(),
                                                       Item5 == null ? 0 : Item5.GetHashCode(),
                                                       Item6 == null ? 0 : Item6.GetHashCode(),
        ...
        public override string ToString()
        {
            ...
            if (rest == null)
            {
                return "(" + (Item1 == null ? null : Item1.ToString()) + ", " + (Item2 == null ? null : Item2.ToString()) + ", " + (Item3 == null ? null : Item3.ToString())
                + ", " + (Item4 == null ? null : Item4.ToString()) + ", " + (Item5 == null ? null : Item5.ToString()) + ", " + (Item6 == null ? null : Item6.ToString())
                + ", " + (Item7 == null ? null : Item7.ToString()) + ", " + Rest.ToString() + ")";
            }
            else
            {
                return "(" + (Item1 == null ? null : Item1.ToString()) + ", " + (Item2 == null ? null : Item2.ToString()) + ", " + (Item3 == null ? null : Item3.ToString())
                + ", " + (Item4 == null ? null : Item4.ToString()) + ", " + (Item5 == null ? null : Item5.ToString()) + ", " + (Item6 == null ? null : Item6.ToString())
                + ", " + (Item7 == null ? null : Item7.ToString()) + ", " + rest.ToStringEnd();
            }
        }
