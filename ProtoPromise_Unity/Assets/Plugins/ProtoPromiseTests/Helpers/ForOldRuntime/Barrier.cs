...
#pragma warning restore 0618
    ...
    public class Barrier : IDisposable
    {
        ...
        {
            get { return Interlocked.Read(ref m_currentPhase); }

            internal set { Interlocked.Exchange(ref m_currentPhase, value); }
        }
...
#pragma warning restore 0420
        ...
        public Boolean SignalAndWait(TimeSpan timeout)
        {
            ...
            {
                throw new System.ArgumentOutOfRangeException("timeout", timeout, "Barrier_SignalAndWait_ArgumentOutOfRange");
            }
            return SignalAndWait((int) timeout.TotalMilliseconds);
        }
        ...
        public bool SignalAndWait(int millisecondsTimeout)
        {
            ...
            {
                throw new System.ArgumentOutOfRangeException("millisecondsTimeout", millisecondsTimeout, "Barrier_SignalAndWait_ArgumentOutOfRange");
            }
            ...
            try
            {
                waitResult = DiscontinuousWait(eventToWaitOn, millisecondsTimeout, phase);
            }
        ...
        private bool DiscontinuousWait(ManualResetEventSlim currentPhaseEvent, int totalTimeout, long observedPhase)
        {
            ...
            while (observedPhase == CurrentPhaseNumber)
            {
                ...
                if (currentPhaseEvent.Wait(waitTime)) return true;
