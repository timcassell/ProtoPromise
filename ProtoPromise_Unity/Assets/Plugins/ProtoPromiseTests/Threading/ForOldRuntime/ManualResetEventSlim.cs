...
namespace System.Threading
{
    ...
    public class ManualResetEventSlim : IDisposable
    {
        ...
        private const int DEFAULT_SPIN_MP = 10; // SpinWait.YIELD_THRESHOLD;
        ...
        private int Waiters
        {
            ...
            set
            {
                ...
                if (value >= NumWaitersState_MaxValue)
                    throw new InvalidOperationException("ManualResetEventSlim_ctor_TooManyWaiters, " + NumWaitersState_MaxValue);
        ...
        public ManualResetEventSlim(bool initialState, int spinCount)
        {
            ...
            if (spinCount > SpinCountState_MaxValue)
            {
                throw new ArgumentOutOfRangeException(
                    "spinCount",
                    "ManualResetEventSlim_ctor_SpinCountOutOfRange, " + SpinCountState_MaxValue);
            }
        ...
        private void Initialize(bool initialState, int spinCount)
        {
            ...
            SpinCount = Environment.ProcessorCount == 1 ? DEFAULT_SPIN_SP : spinCount;
